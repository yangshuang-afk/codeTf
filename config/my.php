...
return [
    ...
    'api_upload_auth'       => true,                //api应用上传是否验证token
    ...
    'oss_default_type'      => 'tencent',      //oss使用类别
    ...
    'qny_oss_client_uploadurl'  => 'http://up-z0.qiniup.com',    //七牛云客户端直传地址
    
    //腾讯云cos配置
    'tencent_oss_secretId'      => '',      //腾讯云keyId
    'tencent_oss_secretKey'     => '',     //腾讯云keysecret
    'tencent_oss_bucket'        => '',        //腾讯云bucket
    'tencent_oss_region'        => '',        //地区
    'tencent_oss_schema'        => 'http',    //访问前缀
    
    //api tf鉴权配置
    'tf_expire_time'        => '+7 day',         //过期时间
    ...
    'tfExpireCode'          => 101,              //tf过期代码
    'tfErrorCode'           => 102,               //tf无效代码
