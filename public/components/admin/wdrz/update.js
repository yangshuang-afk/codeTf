Vue.component('Update', {
    template: `
<el-dialog :close-on-click-modal="false" title="修改" width="95%" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
...
submit() {
    this.$refs['form'].validate(valid => {
        if (valid) {
            ...
            axios.post(base_url + '/Wdrz/update', this.form)
                .then(res => {
