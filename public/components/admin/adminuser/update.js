Vue.component('Update', {
    template: `
<el-dialog :close-on-click-modal="false" title="修改" width="85%" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
        ...
        <el-row >
            <el-col :span="24">
                <el-form-item label="创建时间" prop="create_time">
                    <el-date-picker  value-format="yyyy-MM-dd" type="date" v-model="form.create_time" clearable placeholder="请输入创建时间"></el-date-picker>
...
submit() {
    this.$refs['form'].validate(valid => {
        if (valid) {
            ...
            axios.post(base_url + '/Adminuser/update', this.form)
                .then(res => {
                    if (res.data.status == 200) {
